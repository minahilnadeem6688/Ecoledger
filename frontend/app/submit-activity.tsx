...
import { Button, Card, Field, Grid, IconName, Loading, Notice, PageTitle, Screen, SectionTitle, t, useLayout } from '@/components/ui';
            ...
            {(types.data || []).map((ty) => {
              ...
              return (
                <Pressable
                  ...
                  style={({ hovered }: any) => [s.chip, on && s.chipOn, hovered && !on && { borderColor: C.pink }]}
